...
* extension[reportdetails].extension[reportelement][3].extension[fhirpath].valueString = "name.where(use='official').second().given"
...
* extension[reportdetails].extension[reportelement][4].extension[name].valueString = "family"
* extension[reportdetails].extension[reportelement][4].extension[fhirpath].valueString = "name.where(use='official').family"
* extension[reportdetails].extension[reportelement][4].extension[display].valueString = "Family name"
...
* extension[reportdetails].extension[reportelement][6].extension[name].valueString = "birthDate"
* extension[reportdetails].extension[reportelement][6].extension[fhirpath].valueString = "birthDate"
* extension[reportdetails].extension[reportelement][6].extension[display].valueString = "BirthDate"
...
* extension[reportdetails].extension[reportelement][8].extension[fhirpath].valueString = "telecom.where(system='phone').value"
...
* extension[reportdetails].extension[reportelement][9].extension[name].valueString = "email"
* extension[reportdetails].extension[reportelement][9].extension[fhirpath].valueString = "telecom.where(system='email').value"
* extension[reportdetails].extension[reportelement][9].extension[display].valueString = "Email"
...
* extension[reportdetails].extension[reportelement][10].extension[name].valueString = "district"
* extension[reportdetails].extension[reportelement][10].extension[fhirpath].valueString = "address.where(system='home').district"
* extension[reportdetails].extension[reportelement][10].extension[display].valueString = "District"
...
* extension[reportdetails].extension[reportelement][11].extension[name].valueString = "province"
* extension[reportdetails].extension[reportelement][11].extension[fhirpath].valueString = "address.where(system='home').state"
* extension[reportdetails].extension[reportelement][11].extension[display].valueString = "Province"
...
* extension[reportdetails].extension[reportelement][12].extension[name].valueString = "ihris-related-group"
* extension[reportdetails].extension[reportelement][12].extension[fhirpath].valueString = "Practitioner.extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-related-group').extension.where(url='location').valueString"
