...
* parameter[=].part[=].valueString = "Community"
* parameter[=].part[+].name = "site:site"
* parameter[=].part[=].valueString = "Health Workforce Registry"
...
* parameter[=].part[=].valueString = "2"
* parameter[=].part[+].name = "site:nav:menu:database:menu:educational-level:text"
* parameter[=].part[=].valueString = "Educational Level"
* parameter[=].part[+].name = "site:nav:menu:database:menu:educational-level:url"
* parameter[=].part[=].valueString = "/resource/search/educational-level"
* parameter[=].part[+].name = "site:nav:menu:database:menu:educational-level:order"
* parameter[=].part[=].valueString = "3"
* parameter[=].part[+].name = "site:nav:menu:database:menu:mentorship:text"
* parameter[=].part[=].valueString = "Mentorship Areas"
* parameter[=].part[+].name = "site:nav:menu:database:menu:mentorship:url"
* parameter[=].part[=].valueString = "/resource/search/mentorship"
* parameter[=].part[+].name = "site:nav:menu:database:menu:mentorship:order"
* parameter[=].part[=].valueString = "4"
* parameter[=].part[+].name = "site:nav:menu:database:menu:incentive:text"
* parameter[=].part[=].valueString = "Incentives"
* parameter[=].part[+].name = "site:nav:menu:database:menu:incentive:url"
* parameter[=].part[=].valueString = "/resource/search/incentive"
* parameter[=].part[+].name = "site:nav:menu:database:menu:incentive:order"
* parameter[=].part[=].valueString = "5"
* parameter[=].part[+].name = "site:nav:menu:database:menu:organization:text"
* parameter[=].part[=].valueString = "Organization"
* parameter[=].part[+].name = "site:nav:menu:database:menu:organization:url"
* parameter[=].part[=].valueString = "/resource/search/organization"
* parameter[=].part[+].name = "site:nav:menu:database:menu:organization:order"
* parameter[=].part[=].valueString = "6"
* parameter[=].part[+].name = "site:nav:menu:database:menu:function:text"
* parameter[=].part[=].valueString = "Function"
* parameter[=].part[+].name = "site:nav:menu:database:menu:function:url"
* parameter[=].part[=].valueString = "/resource/search/function"
* parameter[=].part[+].name = "site:nav:menu:database:menu:function:order"
