...
* parameter[=].part[+].name = "site:nav:menu:database:menu:employment-terms:text"
* parameter[=].part[=].valueString = "Employment Terms"
* parameter[=].part[+].name = "site:nav:menu:database:menu:employment-terms:url"
* parameter[=].part[=].valueString = "/resource/search/employment-terms"
* parameter[=].part[+].name = "site:nav:menu:database:menu:employment-terms:order"
